...
const coursesDivWrapper = document.querySelector('.estados');
...
function setAttributes(){
    ...
    textInput.setAttribute('name','estados['+inputCounter+']');
    textInput.setAttribute('id','curso'+inputCounter);
    textInput.setAttribute('required', '');
    textInput.setAttribute('placeholder', 'Nombre del estado');
}
...
function setClassNames(){
    ...
    rowDiv.className= 'row mb-3 estado'+inputCounter;
    textInput.className = "form-control estadoInput"
...
function configureBtnDelete(){
    ...
    btnDeleteField.onclick = function(){
        ...
        var id = this.id;
        document.querySelector('.estado'+id).remove();
    };
}
